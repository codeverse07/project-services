                        ...
                        filteredBookings.map((booking, index) => {
                            ...
                            return (
                                <motion.div
                                    ...
                                    className={`booking-card-item relative rounded-[2rem] shadow-[0_2px_12px_rgb(0,0,0,0.04)] dark:shadow-black/40 ring-1 ring-transparent dark:ring-white/5 transition-all duration-300 transform rotating-border-bookings ${activeBookingId === booking.id ? 'active scale-[1.02] shadow-2xl' : 'scale-100'}`}
                                >
